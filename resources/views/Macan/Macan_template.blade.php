...
<body>
    <header>
        <img id="hero-image" class="hero-image" src="{{ asset('images/variant_demo_1.jpg') }}" alt="">
        <div class="hero-content">
            <h1>Title</h1>
            <h3>This is some dummy description that can load here for the time being because I don't have a proper description to use.</h3>
        </div>
    </header>
    ...
    <section class="specification-section">
        <div class="specification-container">
            ...
            <img src="{{ asset('images/Porsche_911_rear.avif') }}" alt="">
        </div>
    </section>

    <section class="gallery-section">
        <div class="gallery-container">
            <img id="gallery-1" src="{{ asset('images/gallery_1.avif') }}" alt="">
            <img id="gallery-2" src="{{ asset('images/gallery_2.avif') }}" alt="">
            <img id="gallery-3" src="{{ asset('images/gallery_3.avif') }}" alt="">
        </div>
    </section>
    ...
    <section class="drive-parallax-section">
        <section class="drive-parallax-container">
            <img id="drive-parallax-image" class="drive-parallax-image" src="{{ asset('images/drive_parallax.avif') }}" alt="">
        </section>
    </section>
    ...
    <section class="engine-section">
        <div class="engine-content">
            ...
            <h5>Special traditions stand the test of time: the heart of the 911 still beats at the rear - and sets the pulse of Porsche enthusiasts racing even faster than it did 60 years ago.</h5>
        </div>
