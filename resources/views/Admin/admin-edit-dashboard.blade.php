        ...
        <div class="add_model_form">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.addcar') }}" method="POST" enctype="multipart/form-data" class="admin_form">
                        @csrf
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="ordering_index" min="1" max="5">
                            </div>
                        </div>
        ...
        <div class="add_variant_form">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.addvariant') }}" method="POST" enctype="multipart/form-data" class="admin_form">
                        @csrf
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="fuel_type" class="form-control" name="fuel_type" placeholder="Petrol" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="gallery_content">Drive content</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">Rear Profile</label>
                            <input type="file" class="form-control" name="rear_profile">
                        </div>
